...
define('DB_PORT', '3306');
define('DB_USER', 'root');
define('DB_PASS', 'root');  // Change if you set a password
define('DB_NAME', 'petvet');
define('DB_CHARSET', 'utf8mb4');
define('DB_USE_SSL', false);  // Set to false for localhost

// // TiDB Database credentials (Online)
...
function db(): PDO {
    ...
    if ($pdo === null) {
        ...
        // Add SSL options only if DB_USE_SSL is true
        if (DB_USE_SSL) {
...
// Set SSL options only if DB_USE_SSL is true
if (DB_USE_SSL) {
