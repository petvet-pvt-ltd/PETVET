...
function renderKPIs(data){
  ...
  if (kpiTotalEl) kpiTotalEl.textContent = data.appointments.length;
}
...
function goToForm(page, apptId){
  location.href = `/PETVET/?module=vet&page=${page}&from=ongoing&appointment=${encodeURIComponent(apptId)}`;
}
