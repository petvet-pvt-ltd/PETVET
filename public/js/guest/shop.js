...
function setupLoadingAnimations() {
    ...
    // Only apply initial animation if cards haven't been animated yet
    const needsAnimation = Array.from(cards).some(card => 
        !card.style.opacity && !card.hasAttribute('data-animated')
    );
    ...
    cards.forEach((card, index) => {
        // Only animate cards that haven't been animated
