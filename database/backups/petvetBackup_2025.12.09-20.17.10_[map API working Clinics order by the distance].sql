...
-- =============================================
-- Database: petvetDB
-- Backup Date: 2025-12-09 20:17:11
-- Timestamp: 2025.12.09-20.17.10
-- Description: map API working. Clinics order by the distance
-- =============================================
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=90027;
...
('30027', '26', '2', '1', '19', 'routine', '', '2025-12-08', '09:00:00', '20', 'declined', '', '2025-12-07 08:50:00', '2025-12-09 12:56:59', NULL, NULL),
('60027', '26', '2', '1', '19', 'routine', '', '2025-12-10', '09:00:00', '20', 'declined', '', '2025-12-09 12:57:13', '2025-12-09 13:07:55', NULL, NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AUTO_INCREMENT=60057;
...
('1', '1', 'monday', '1', '08:00:00', '23:00:00', '2025-12-03 14:40:05', '2025-12-09 13:51:12'),
('2', '1', 'tuesday', '1', '08:00:00', '23:00:00', '2025-12-03 14:40:05', '2025-12-09 13:51:12'),
('3', '1', 'wednesday', '1', '08:00:00', '23:00:00', '2025-12-03 14:40:05', '2025-12-09 13:51:12'),
('4', '1', 'thursday', '1', '08:00:00', '23:00:00', '2025-12-03 14:40:05', '2025-12-09 13:51:12'),
('5', '1', 'friday', '0', '08:00:00', '23:00:00', '2025-12-03 14:40:05', '2025-12-09 13:51:12'),
('6', '1', 'saturday', '1', '08:00:00', '23:00:00', '2025-12-03 14:40:05', '2025-12-09 13:51:12'),
('7', '1', 'sunday', '1', '08:00:00', '23:00:00', '2025-12-03 14:40:06', '2025-12-09 13:51:13'),
...
('1', 'Happy Paws Veterinary Clinic', 'Trusted pet healthcare and wellness. Experienced vets, modern facilities, and friendly service.', 'https://static.vecteezy.com/system/resources/previews/005/601/780/non_2x/veterinary-clinic-logo-vector.jpg', 'https://img.freepik.com/free-vector/veterinary-clinic-social-media-cover-template_23-2149716789.jpg', '123 Main Street, Colombo', '7.005906268476923, 79.98341548112737', 'Colombo', 'Colombo 07', '0112345678', 'info@happypaws.lk', NULL, NULL, 'approved', '1', '2025-10-21 06:59:16', '2025-12-09 14:31:29'),
('2', 'Best Care Animal Hospital', 'Professional veterinary care for your beloved pets.', 'https://static.vecteezy.com/system/resources/thumbnails/017/352/349/small/illustration-of-the-logo-of-a-veterinary-clinic-vector.jpg', 'https://img.freepik.com/free-vector/veterinary-clinic-social-media-cover-template_23-2149716789.jpg', '145/2/1', '6.878769980154205, 79.89406099519034', 'Colombo', 'Colombo 05', '0775983002', 'allinone@gmail.com', NULL, NULL, 'approved', '1', '2025-10-22 08:52:57', '2025-12-09 14:43:45'),
('3', 'Akila Veterenary Clinic', NULL, 'https://static.vecteezy.com/system/resources/thumbnails/025/946/559/small_2x/pets-dog-care-healthcare-veterinarian-medical-clinic-treatment-modern-minimal-mascot-simple-logo-icon-illustration-vector.jpg', 'https://img.freepik.com/free-vector/veterinary-cli...', '145/2/1', '7.027640109440356, 79.97805927984973', 'Gampaha', 'Kadawatha', '0775983002', 'gklnkler@gmail.com', NULL, NULL, 'approved', '1', '2025-10-22 10:13:19', '2025-12-09 14:45:17');


-- =============================================
-- Table structure for table `favorite_clinics`
-- =============================================
...
CREATE TABLE `favorite_clinics` (
  ...
  KEY `fk_2` (`clinic_id`),
  CONSTRAINT `fk_1` FOREIGN KEY (`user_id`) REFERENCES `petvetDB`.`users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_2` FOREIGN KEY (`clinic_id`) REFERENCES `petvetDB`.`clinics` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=30001;

-- Dumping data for table `favorite_clinics`

INSERT INTO `favorite_clinics` (`id`, `user_id`, `clinic_id`, `created_at`) VALUES
('2', '2', '1', '2025-12-09 13:35:37'),
('3', '2', '3', '2025-12-09 14:38:15');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=240235 COMMENT='Track login attempts for security';

-- Dumping data for table `login_attempts`

INSERT INTO `login_attempts` (`id`, `email`, `ip_address`, `attempted_at`, `success`) VALUES
('120235', 'manager@gmail.com', '::1', '2025-12-09 07:37:36', '1'),
('120236', 'petowner@gmail.com', '::1', '2025-12-09 07:40:43', '1'),
('150235', 'manager@gmail.com', '::1', '2025-12-09 08:29:37', '1'),
('180235', 'petowner@gmail.com', '192.168.1.2', '2025-12-09 09:40:20', '1'),
('180236', 'petowner@gmail.com', '::1', '2025-12-09 09:46:04', '0'),
('180237', 'petowner@gmail.com', '::1', '2025-12-09 09:46:13', '1'),
('180238', 'petowner@gmail.com', '::1', '2025-12-09 09:46:53', '1'),
('180239', 'petowner@gmail.com', '::1', '2025-12-09 09:48:58', '1'),
('210235', 'manager@gmail.com', '::1', '2025-12-09 13:42:39', '0'),
('210236', 'manager@gmail.com', '::1', '2025-12-09 13:42:52', '1'),
('210237', 'petowner@gmail.com', '::1', '2025-12-09 13:57:57', '0'),
('210238', 'petowner@gmail.com', '::1', '2025-12-09 13:58:10', '1'),
('210239', 'petowner@gmail.com', '192.168.1.2', '2025-12-09 14:10:51', '1'),
('210240', 'petowner@gmail.com', '::1', '2025-12-09 14:25:46', '1'),
('210241', 'petowner@gmail.com', '::1', '2025-12-09 14:28:24', '1');
...
('2', 'petowner@gmail.com', '$2y$10$BOoPpJZc7z0avhTFr0zgJ.9ifJI3bFnTZFue/JDvExdM5NeFi9B.2', 'Hesara', 'Liyanage', '0775983002', '145/2/1, Gonahena, Kadawatha', '/PETVET/uploads/avatars/avatar_1764576816_692d4e30557c5.jpg', '1', NULL, '1', '0', '2025-12-09 14:28:24', '2025-10-21 06:59:16', '2025-12-09 14:28:24'),
...
('9', 'manager@gmail.com', '$2y$10$BINhO08G1d0W.jnwQ/xHDeDz.B9uzRxfgo9.osphNDGYUPYlESdHi', 'Cpt ', 'Dihindu', '0776234567', NULL, '/PETVET/uploads/avatars/avatar_1764764545_69302b8124546.png', '1', NULL, '1', '0', '2025-12-09 13:42:52', '2025-10-21 08:17:00', '2025-12-09 13:42:52'),
