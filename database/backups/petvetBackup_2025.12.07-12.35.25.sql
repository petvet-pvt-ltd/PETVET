...
-- =============================================
-- Database: petvetDB
-- Backup Date: 2025-12-07 12:35:25
-- Timestamp: 2025.12.07-12.35.25
-- =============================================
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=30235 COMMENT='Track login attempts for security';
...
('235', 'petowner@gmail.com', '::1', '2025-12-06 15:50:58', '1');
...
CREATE TABLE `products` (
  ...
  KEY `idx_is_active` (`is_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=30025;
...
('2', 'petowner@gmail.com', '$2y$10$BOoPpJZc7z0avhTFr0zgJ.9ifJI3bFnTZFue/JDvExdM5NeFi9B.2', 'Hesara', 'Liyanage', '0775983002', '145/2/1, Gonahena, Kadawatha', '/PETVET/uploads/avatars/avatar_1764576816_692d4e30557c5.jpg', '1', NULL, '1', '0', '2025-12-06 15:50:59', '2025-10-21 06:59:16', '2025-12-06 15:50:59'),
...
CREATE TABLE `vet_profiles` (
  ...
  KEY `idx_user` (`user_id`),
  CONSTRAINT `vet_profiles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `petvetDB`.`users` (`id`) ON DELETE CASCADE,
