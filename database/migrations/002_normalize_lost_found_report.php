...
try {
    ...
    foreach ($reports as $report) {
        ...
        $species = $description['species'] ?? null;
        $name = $description['name'] ?? null;
        $breed = $description['breed'] ?? null;
        $color = $description['color'] ?? null;
        $age = $description['age'] ?? null;
        $notes = $description['notes'] ?? null;
        $time = $description['time'] ?? null;
        $reward = isset($description['reward']) ? (float)$description['reward'] : null;
        $urgency = $description['urgency'] ?? 'medium';
        $phone = $description['contact']['phone'] ?? null;
        $phone2 = $description['contact']['phone2'] ?? null;
        $email = $description['contact']['email'] ?? null;
        ...
        $submitted_at = $description['submitted_at'] ?? date('Y-m-d H:i:s');
