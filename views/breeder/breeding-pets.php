                            ...
                            <td data-label="Actions">
                                <div class="action-buttons">
                                    ...
                                    <button class="btn-icon-action delete" 
                                        ...
                                        onclick="showDeleteConfirmation(this.dataset.petId, this.dataset.petName)" 
                                        title="Delete">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            ...
            <div class="modal-body">
                <form id="petForm" enctype="multipart/form-data">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label for="petDob">Date of Birth * (Must be older than 1 year)</label>
                            <input type="date" id="petDob" name="dob" class="form-control" required max="<?php echo date('Y-m-d', strtotime('-1 year')); ?>">
                        </div>
