...
<head>
    ...
    <link rel="stylesheet" href="<?= asset('css/breeder/availability.css') ?>">
</head>
<body>
        ...
        <div class="page-wrap">
            ...
            <div class="availability-header">
                <div>
                    ...
                    <p class="muted">Configure your breeding service schedule and time-off dates</p>
                </div>
                <nav class="quick-nav">
    ...
    <script src="<?= asset('js/breeder/availability.js') ?>"></script>
</body>
</html>
