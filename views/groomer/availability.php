...
$unavailableDates = ['2025-12-25', '2026-01-01', '2025-10-28'];
...
<head>
    ...
    <title><?= $pageTitle ?> - PetVet Groomer</title>
    <link rel="stylesheet" href="<?= asset('css/groomer/availability.css') ?>">
</head>
<body>
        ...
        <div class="page-wrap">
            ...
            <div class="availability-header">
                <div>
                    ...
                    <p class="muted">Configure your working hours and time-off dates</p>
                </div>
                <nav class="quick-nav">
    ...
    <script src="<?= asset('js/groomer/availability.js') ?>"></script>
</body>
</html>
