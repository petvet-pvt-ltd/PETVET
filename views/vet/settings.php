...
/** Vet Settings (Profile & Preferences) */
...
<title>Settings - Veterinarian - PetVet</title>
						...
						<div class="profile-grid">
							<div class="profile-left">
								<div class="avatar-frame">
									<div class="image-preview-list avatar big" id="vetAvatarPreview">
										<div class="image-preview-item">
											<img src="<?= htmlspecialchars($profile['avatar']) ?>" alt="avatar" />
										</div>
									</div>
									<div class="uploader-actions center">
										<input type="file" id="vetAvatar" name="vetAvatar" accept="image/*" hidden />
										<button type="button" class="btn outline" data-for="vetAvatar">Change</button>
									</div>
								</div>
							</div>
							...
							<div class="row two">
								<label>Specialization
									<input type="text" name="specialization" value="<?= htmlspecialchars($profile['specialization'] ?? '') ?>" placeholder="e.g., Surgery, Dentistry" />
								</label>
								<label>License Number
									<input type="text" name="license_number" value="<?= htmlspecialchars($profile['license_number'] ?? '') ?>" readonly style="background: #f0f0f0; cursor: not-allowed;" />
								</label>
							</div>
							<div class="row one">
								<label>Bio
									<textarea name="bio" rows="3" placeholder="Tell us about yourself and your expertise"><?= htmlspecialchars($profile['bio'] ?? '') ?></textarea>
								</label>
							</div>
								<div class="actions">
...
<script src="/PETVET/public/js/vet/settings.js"></script>
</body>
</html>
